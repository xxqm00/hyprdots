...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 5, bezier = "overshoot", style = "slidefadevert" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 3, bezier = "linear", style = "slidefade" })
